...
Support for standard guitar tuning (E-A-D-G-B-E) and any custom tuning for 6 strings guitars

Posibility to create songs with tunings and tabs to load them
